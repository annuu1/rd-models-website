export const blogData = [{
  ...
  <p>Walk into any architecture studio or design office and you'll likely spot a physical model sitting quietly in a corner. To most, it looks like a simple object—a miniature version of a building, perhaps made of cardboard, foam, or acrylic. But to those who understand what goes into making one, that object is the result of hours, often days, of intense, hands-on work. At RD Models, we believe it's time to recognise architectural model making for what it truly is: an art form. And model makers? We're artists—with a precision knife in one hand and a deadline in the other.</p>
      ...
      `,
  "excerpt": "Explore how emerging technologies like AR, VR, and real-time rendering are transforming the way architects and developers visualize projects. Learn about the latest tools and techniques that are setting new standards in the industry.",
  "category": "Craftsmanship",
  "tags": [["Architectural Models", "Craftsmanship", "Art", "Model Making", "Architecture"]],
  "author": "Ar. Urvashi Vasishtha",
  "authorTitle": "",
  "authorImage": {
    "url": "https://res.cloudinary.com/dp8l2hrt1/image/upload/v1751009690/rdmod/gen/team/olcuijb6csiwq8zrraxn.jpg",
    "publicId": "rd-models/blog/author-images/file_ecacrm"
  },
  "image": {
    "url": "https://zzbsgmn7m1siorzp.public.blob.vercel-storage.com/blog/blog_1.jpg",
    "publicId": "rd-models/blog/images/file_jcu0un"
  },
  "status": "draft",
  "featured": false,
  "readTime": 1,
  ...
  "metaDescription": "",
  "createdBy": {
    "$oid": "685bafeb8de102ca0ded17a6"
  },
  "createdAt": {
    "$date": "2025-07-01T08:20:34.896Z"
  },
  "updatedAt": {
    "$date": "2025-07-01T08:20:34.896Z"
  },
